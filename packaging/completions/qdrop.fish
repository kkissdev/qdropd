...
complete -c qdrop -n "__fish_qdrop_using_subcommand help; and not __fish_seen_subcommand_from pair peers send recv paste copy open clip auth status daemon help" -f -a "pair" -d 'Pair with another device, or manage existing pairings'
complete -c qdrop -n "__fish_qdrop_using_subcommand help; and not __fish_seen_subcommand_from pair peers send recv paste copy open clip auth status daemon help" -f -a "peers" -d 'List paired peers and their status'
complete -c qdrop -n "__fish_qdrop_using_subcommand help; and not __fish_seen_subcommand_from pair peers send recv paste copy open clip auth status daemon help" -f -a "send" -d 'Send one or more files to a peer (use `-` for stdin)'
complete -c qdrop -n "__fish_qdrop_using_subcommand help; and not __fish_seen_subcommand_from pair peers send recv paste copy open clip auth status daemon help" -f -a "recv" -d 'Wait for an incoming file; print its path or stream it to stdout'
complete -c qdrop -n "__fish_qdrop_using_subcommand help; and not __fish_seen_subcommand_from pair peers send recv paste copy open clip auth status daemon help" -f -a "paste" -d 'Print a peer\'s shared clipboard text to stdout'
complete -c qdrop -n "__fish_qdrop_using_subcommand help; and not __fish_seen_subcommand_from pair peers send recv paste copy open clip auth status daemon help" -f -a "copy" -d 'Read stdin and set it as the shared clipboard'
complete -c qdrop -n "__fish_qdrop_using_subcommand help; and not __fish_seen_subcommand_from pair peers send recv paste copy open clip auth status daemon help" -f -a "open" -d 'Open a URL on a peer'
complete -c qdrop -n "__fish_qdrop_using_subcommand help; and not __fish_seen_subcommand_from pair peers send recv paste copy open clip auth status daemon help" -f -a "clip" -d 'Control clipboard synchronization'
complete -c qdrop -n "__fish_qdrop_using_subcommand help; and not __fish_seen_subcommand_from pair peers send recv paste copy open clip auth status daemon help" -f -a "auth" -d 'Pre-authorize a paired peer to send here unattended'
complete -c qdrop -n "__fish_qdrop_using_subcommand help; and not __fish_seen_subcommand_from pair peers send recv paste copy open clip auth status daemon help" -f -a "status" -d 'Show live daemon status (peers, clipboard)'
complete -c qdrop -n "__fish_qdrop_using_subcommand help; and not __fish_seen_subcommand_from pair peers send recv paste copy open clip auth status daemon help" -f -a "daemon" -d 'Run the qdrop daemon in the foreground'
complete -c qdrop -n "__fish_qdrop_using_subcommand help; and not __fish_seen_subcommand_from pair peers send recv paste copy open clip auth status daemon help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
