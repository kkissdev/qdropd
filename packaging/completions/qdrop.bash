_qdrop() {
    ...
    do
        case "${cmd},${i}" in
            ...
            qdrop,daemon)
                ...
                ;;
            qdrop,doctor)
                cmd="qdrop__subcmd__doctor"
                ;;
            qdrop,help)
                cmd="qdrop__subcmd__help"
                ;;
            qdrop,open)
                cmd="qdrop__subcmd__open"
                ;;
            qdrop,pair)
            ...
            qdrop__subcmd__help,daemon)
                ...
                ;;
            qdrop__subcmd__help,doctor)
                cmd="qdrop__subcmd__help__subcmd__doctor"
                ;;
            qdrop__subcmd__help,help)
                cmd="qdrop__subcmd__help__subcmd__help"
                ;;
            qdrop__subcmd__help,open)
                cmd="qdrop__subcmd__help__subcmd__open"
                ;;
            ...
            qdrop__subcmd__help,send)
                ...
                ;;
            qdrop__subcmd__help,status)
                cmd="qdrop__subcmd__help__subcmd__status"
                ;;
            *)
                ;;
        esac
    ...
    case "${cmd}" in
        qdrop)
            opts="-v -q -h -V --verbose --quiet --help --version pair peers send recv paste copy open clip auth status doctor daemon help"
        ...
        qdrop__subcmd__doctor)
            ...
            ;;
        qdrop__subcmd__help)
            opts="pair peers send recv paste copy open clip auth status doctor daemon help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        qdrop__subcmd__help__subcmd__copy)
            ...
            return 0
            ;;
        qdrop__subcmd__help__subcmd__daemon)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        qdrop__subcmd__help__subcmd__doctor)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        qdrop__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        qdrop__subcmd__help__subcmd__open)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        qdrop__subcmd__help__subcmd__pair)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        qdrop__subcmd__help__subcmd__recv)
            ...
            return 0
            ;;
        qdrop__subcmd__help__subcmd__send)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        qdrop__subcmd__help__subcmd__status)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
...
if [[ "${BASH_VERSINFO[0]}" -eq 4 && "${BASH_VERSINFO[1]}" -ge 4 || "${BASH_VERSINFO[0]}" -gt 4 ]]; then
    complete -F _qdrop -o nosort -o bashdefault -o default qdrop
else
    complete -F _qdrop -o bashdefault -o default qdrop
fi
